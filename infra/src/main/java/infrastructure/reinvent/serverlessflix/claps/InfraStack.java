...
public class InfraStack extends Stack {
    ...
    public InfraStack(final Construct scope, final String id, final StackProps props) {
        ...
        var notifyCreatorHandler = Function.Builder.create(this,"NotifyCreatorHandler")
                ...
                .code(Code.fromAsset("../software/scheduled-job/target/svs402-scheduled-job-1.0.jar"))
                .tracing(Tracing.ACTIVE)
                .environment(Map.of(
                        "TABLE_NAME", videoClapsTable.getTableName()))
                .build();

        videoClapsTable.grantReadData(notifyCreatorHandler);
        ...
        var newVideoHandler = Function.Builder.create(this,"NewVideoHandler")
                ...
                .timeout(Duration.seconds(30))
                .snapStart(SnapStartConf.ON_PUBLISHED_VERSIONS)
                .code(Code.fromAsset("../software/new-video-function/target/svs402-new-video-function-1.0.jar"))
                .tracing(Tracing.ACTIVE)
                .environment(Map.of(
                        "TABLE_NAME", videoClapsTable.getTableName(),
        ...
        var newVideoRule = Rule.Builder.create(this, "NewVideoRule")
        ...
        var clapsRestApiFunction = Function.Builder.create(this, "VideoRestApiFunction")
                ...
                .code(Code.fromAsset("../software/rest-api/target/svs402-rest-api-1.0.jar"))
        ...
        var integration = LambdaIntegration.Builder.create(clapsRestApiFunction.getCurrentVersion()).build();
        ...
        var clapProcessor = Function.Builder.create(this,"ClapProcessor")
                ...
                .timeout(Duration.seconds(30))
                .snapStart(SnapStartConf.ON_PUBLISHED_VERSIONS)
                .code(Code.fromAsset("../software/clap-processor/target/svs402-clap-processor-1.0.jar"))
                .tracing(Tracing.ACTIVE)
                .environment(Map.of(
                        "TABLE_NAME", videoClapsTable.getTableName())
                )
